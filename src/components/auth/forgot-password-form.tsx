...
export function ForgotPasswordForm({ t, redirectPath, authService }: ForgotPasswordFormProps) {
    ...
    return (
        <>
            ...
            <div className="text-xs text-center text-gray-500 mt-6">© 2025 Property Hub, Qatar. All Rights Reserved</div>
        </>
    )
}
