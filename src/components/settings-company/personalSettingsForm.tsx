...
export const PersonalSettingsForm = forwardRef<any, PersonalSettingsFormProps>(({ userData }, ref) => {
    const t = useTranslations()
    const [isSubmitting, setIsSubmitting] = useState(false)
    const [isUploading, setIsUploading] = useState(false)
    const [profileImage, setProfileImage] = useState<string | null>(userData.profilePhoto || null)
        ...
        <div className="p-14">
            ...
            <div className="flex items-center gap-6 mb-8">
                <div className="relative">
                    <UserAvatar src={profileImage || "asdfasdfa"} firstName={userData.firstName} lastName={userData.lastName} size="xl" />
                </div>
            ...
            <h3 className="text-base font-semibold mb-4">{t("title.personalDetails") || "Personal Details"}</h3>
                ...
                <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <Select onValueChange={field.onChange} defaultValue={field.value} disabled={!userData.isOwner}>
                                        <FormControl>
                                            <SelectTrigger>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormLabel>{t("form.languagesSpoken.label") || "Languages Spoken"}</FormLabel>
                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                        <FormControl>
                                            <SelectTrigger>
                                                <SelectValue placeholder={t("form.languagesSpoken.placeholder") || "Select languages"} />
                                            </SelectTrigger>
                                        </FormControl>
                                        <SelectContent>
