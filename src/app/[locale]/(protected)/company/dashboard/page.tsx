...
export default function DashboardPage() {
    ...
    return (
        // remove div's own stylings
        <>
            <Loader isLoading={isMetricsLoading} variant="inline" />
            <div className="mx-auto px-4 py-6 relative">
                ...
                {activeView === "dashboard" && (
                    <>
                        ...
                        {!isMetricsLoading && <DashboardView {...dashboardProps as any} timeframe={timeframe} setTimeframe={setTimeframe} />}
                    </>
                )}
