...
export default function DashboardPage() {
  ...
  return (
    <div className="mx-auto px-4 py-6">
      ...
      {activeView === "agents" && (
        <AgentsInsightsView onBack={() => setActiveView("dashboard")} />
      )}
      {activeView === "properties" && (
        <PropertiesInsightsView onBack={() => setActiveView("dashboard")} />
      )}
      {activeView === "leads" && (
        <LeadsInsightsView onBack={() => setActiveView("dashboard")} />
      )}
    </div>
  );
}
